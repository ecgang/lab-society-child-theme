...
function wc_custom_store_notice_updated( $text ) {
    return str_replace( 'replace', 'SITEWIDE SALE! Use discount code: HAPPY4TH at checkout to receive 10% of your entire order! <a href="tel:1-720-600-2037" class="call-head">Need Help? Call us now! 720-600-2037</a>', $text );
}
