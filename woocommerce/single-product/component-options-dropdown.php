...
?><div class="component_options_select_wrapper" <?php echo $hide_dropdown ? 'style="display:none;"' : ''; ?>>
	<select id="component_options_<?php echo $component_id; ?>" class="component_options_select mdc-select" name="wccp_component_selection[<?php echo $component_id; ?>]"></select>
</div>
